...
if __name__ == "__main__":
	...
	#model_last.fit(x_train, y_train, epochs=4, verbose=2)
	...
	score_concat = ultimate_evaluate("actually-last-pred.json", model_last, x_test, y_test, q_test, i_to_a)
	print("No embed score: {}".format(score_concat))
