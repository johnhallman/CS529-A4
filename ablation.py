...
if __name__ == "__main__":
	...
	bow_1 = bow_model_1(x_train, y_train, embedding)
	bow_2 = bow_model_2(x_train, y_train, embedding)
	score_1 = ultimate_evaluate("bow-1-preds.json", bow_1, x_test, y_test, q_test, i_to_a)
	score_2 = ultimate_evaluate("bow-2-preds.json", bow_2, x_test, y_test, q_test, i_to_a)
	print("Bow 1 score: {}".format(score_1))
	print("Bow 2 score: {}".format(score_2))

	print(" - Model finished training and evaluation")
